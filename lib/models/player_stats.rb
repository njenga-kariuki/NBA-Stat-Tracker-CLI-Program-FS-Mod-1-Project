...
#define API call to return a players stats and sort them from ost recent game
  ...
  #   # Init
  #   # newsapi = News.new("REMOVED_HISTORICAL_CREDENTIAL")
  #
  ...
  #
  #   # url = 'https://newsapi.org/v2/everything?sources=espn&q=Lebron&sort_by=published_at.start=NOW-3DAYS&apiKey=REMOVED_HISTORICAL_CREDENTIAL'
  #     url = 'https://newsapi.org/v2/everything?sources=espn,fox-sports&q=lebron&apiKey=REMOVED_HISTORICAL_CREDENTIAL'
  #   req = open(url)
